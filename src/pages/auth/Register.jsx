...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username || !email || !password || !skinType) {
    ...
    try {
      setError('');
      setLoading(true);
      await signup(email, password, username, skinType);
      navigate('/dashboard');
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-lavender-50 via-white to-mint-50 px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-md">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-display font-bold text-gray-800">Create your account</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                id="skinType"
                name="skinType"
                className="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-lavender-500 focus:border-lavender-500"
                value={skinType}
